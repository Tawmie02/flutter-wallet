...
import 'package:my_pocket_wallet/screens/account.dart';
...
import 'package:my_pocket_wallet/screens/pages/withdraw.dart'; // Withdraw page.
import 'package:my_pocket_wallet/screens/pages/send_money_page.dart'; // Send Money Practice Page
    ...
    return Expanded(
      child: GridView.count(
        ...
        children: [
          ...
          _buildMenuItem(
            Icons.send_rounded,
            'Send\nMoney', // Label for the send money button.
